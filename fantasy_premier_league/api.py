...
def get_league_team_histories(team_ids, game='FPL', overwrite=False):
    """Get all teams' histories"""

    if overwrite:
        return team.download_all_teams_histories(game, team_ids)
    
    return team.read_histories(game, team_ids)
